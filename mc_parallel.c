...
int main()
{
    ...
    #pragma omp parallel private(nthreads, tid)
    {
        ...
        fprintf(fp, "set srcname ______\n");
        fprintf(fp, "set localdir /localscratch/ahollett/${srcname}\n");
	fprintf(fp, "set fakedir /localscratch/ahollett/${srcname}\n");
        ...
        fprintf(fp, "set fileout [open ${sharedir}/results/fake_10eVresult_T%d.dat w]\n", tid);
        ...
        fprintf(fp, "@${sharedir}/scripts/montecarlo.xcm\n");
        pclose(fp);
